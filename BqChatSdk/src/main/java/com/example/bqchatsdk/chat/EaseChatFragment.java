...
import com.example.bqchatsdk.activities.EaseImageGridActivity;
import com.example.bqchatsdk.base.EaseBaseFragment;
...
import com.example.bqchatsdk.chat.interfaces.OnChatExtendMenuItemClickListener;
import com.example.bqchatsdk.chat.interfaces.OnChatInputChangeListener;
import com.example.bqchatsdk.chat.interfaces.OnChatLayoutFinishInflateListener;
...
import com.example.bqchatsdk.chat.interfaces.OnMessageItemClickListener;
import com.example.bqchatsdk.chat.interfaces.OnMessageSendCallBack;
import com.example.bqchatsdk.chat.interfaces.OnPeerTypingListener;
...
import com.example.bqchatsdk.chat.widget.EaseChatExtendMenuDialog;
...
public class EaseChatFragment extends EaseBaseFragment implements OnChatLayoutListener, OnMenuChangeListener,
    ...
    //ALEXANDER
    private OnChatPrimaryMenuItemClickListener primaryMenuItemClickListener;
    ...
    private void setOnPrimaryMenuItemClickListener(OnChatPrimaryMenuItemClickListener listener){
        this.primaryMenuItemClickListener = listener;
    }
    ...
    public static class Builder {
        ...
        public Builder setOnPrimaryMenuItemClickListener(OnChatPrimaryMenuItemClickListener listener){
            this.primaryMenuItemClickListener = listener;
            return this;
        }
        ...
        public EaseChatFragment build() {
            ...
            fragment.setOnPrimaryMenuItemClickListener(this.primaryMenuItemClickListener);
